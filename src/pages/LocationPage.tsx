    ...
    <Layout>
      ...
      <section className="section-surface section-padding">
        <div className="container-content max-w-3xl">
          <h2 className="text-xl md:text-2xl mb-4">Why Lake Side Roofing Group in {loc.name}</h2>
          <div className="heading-rule" />
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        itemListElement: [
          ...
          { "@type": "ListItem", position: 3, name: loc.name, item: { "@type": "Thing", "@id": `https://www.lakesideroofinggroup.co.uk/locations/${loc.slug}` } }
        ]
      })}} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
