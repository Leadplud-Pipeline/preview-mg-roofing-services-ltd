...
const ServicesHub = () => (
  <Layout>
    <SEO title="Our Roofing Services | Lake Side Roofing Group" description="Complete roofing services across the Lake District & Lancashire: emergency repairs, replacements, flat roofing, guttering, and more. Free roof inspections." />
