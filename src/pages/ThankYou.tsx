...
const ThankYou = () => {
  ...
  return (
  <Layout>
    <SEO title="Thank You - We'll Be in Touch Shortly | Lake Side Roofing Group" description="Thank you for contacting Lake Side Roofing Group. We'll review your enquiry and be in touch shortly." robots="noindex, nofollow" />
    <section className="section-light section-padding">
      <div className="container-content text-center max-w-2xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <a href="tel:07480104865" className="btn-primary">Call Us Now: 07480 104865</a>
