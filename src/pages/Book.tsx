...
const Book = () => {
  ...
  return (
    <Layout>
      <SEO title="Book Your Free Roof Inspection & Estimate | Lake Side Roofing Group" description="Book a free roof inspection and roofing estimate with Lake Side Roofing Group. No obligation, completely free." robots="noindex, nofollow" />
