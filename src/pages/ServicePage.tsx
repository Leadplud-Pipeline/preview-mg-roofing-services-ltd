  ...
  return (
    <Layout>
      ...
      <section className="section-dark section-padding">
        <div className="container-content">
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <h1 className="text-3xl md:text-5xl text-secondary-foreground">{service.name} in the Lake District & Lancashire</h1>
          </div>
      ...
      <section className="section-surface section-padding">
        <div className="container-content max-w-3xl">
          <h2 className="text-xl md:text-2xl mb-4">Why Choose Lake Side Roofing Group</h2>
          <div className="heading-rule" />
          <ul className="space-y-3">
        ...
        <div className="container-content max-w-3xl">
          ...
          {slug === "emergency-roof-repairs" && (
            <p className="font-sans text-muted-foreground mb-4">
              Based in Blackpool or the Fylde Coast? See our dedicated{" "}
              <Link to="/emergency-roof-repair-blackpool" className="text-primary font-semibold hover:underline">Emergency Roof Repair Blackpool page</Link>{" "}
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        itemListElement: [
          ...
          { "@type": "ListItem", position: 3, name: service.name, item: { "@type": "Thing", "@id": `https://www.lakesideroofinggroup.co.uk/services/${service.slug}` } }
        ]
      })}} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        "@context": "https://schema.org", "@type": "Service", name: service.name,
        provider: { "@type": "HomeAndConstructionBusiness", name: "Lake Side Roofing Group", telephone: "07480104865", address: { "@type": "PostalAddress", streetAddress: "23 Vicarage Lane", addressLocality: "Blackpool", postalCode: "FY4 4EF", addressRegion: "Lancashire", addressCountry: "GB" } },
        areaServed: "Cumbria and Lancashire, North West England", description: service.heroDesc
      })}} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
